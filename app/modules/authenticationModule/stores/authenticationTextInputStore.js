 ...
 */
var debug = require('debug')('AuthenticationTextInputStore');
import {BaseStore} from 'fluxible/addons';
import Actions from "../actions/constant";

class AuthenticationTextInputStore extends BaseStore {
    ...
    updateStore(payload) {
        ...
        if (payload.fieldName != undefined && payload.values != undefined) {
            ...
            /*
            if (payload.values.fieldAfter !== undefined && this.propStore[payload.fieldName].fieldAfter != payload.values.fieldAfter) {
                changes = true;
                this.propStore[payload.fieldName].fieldAfter = payload.values.fieldAfter;
            }*/
...
AuthenticationTextInputStore.storeName = 'authenticationTextInputStore';
AuthenticationTextInputStore.handlers = {
    [Actions.AUTHENTICATION_UPDATE_TEXTINPUT_STORE]: 'updateStore',
    [Actions.AUTHENTICATION_RESET_TEXTINPUT_STORE]: 'resetStore'
};

export default AuthenticationTextInputStore;